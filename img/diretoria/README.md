...
Drope nesta pasta as fotos quadradas (recomendado: 600x600px, JPG) com os
nomes exatos abaixo. A página `pages/diretoria.html` carrega automaticamente
e cai para iniciais quando o arquivo não existe.
